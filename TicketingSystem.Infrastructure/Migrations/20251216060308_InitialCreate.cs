        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tickets_DomainUsers_AssignedToAgentId",
                        column: x => x.AssignedToAgentId,
                        principalTable: "DomainUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Tickets_DomainUsers_ClientId",
                        column: x => x.ClientId,
                        principalTable: "DomainUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketMessages_DomainUsers_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "DomainUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DomainUsers_IsActive",
                table: "DomainUsers",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_DomainUsers_Role",
                table: "DomainUsers",
                column: "Role");
